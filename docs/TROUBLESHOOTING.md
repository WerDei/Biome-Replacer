...
**Some modded biomes:** Biome Replacer works with the TerraBlender, Blueprint, Biolith (on 1.20+) and Lithostitched (on 1.21.1+) biome libraries. It does not support other biome libraries.
